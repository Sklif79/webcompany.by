...
(function(factory) {
    ...
    Plugin.prototype = {
        ...
        getVisibleItemCount: function() {
            return $('li.overhead', self.nav_visible).length;
        },
        getHiddenItemCount: function() {
            return $('li.overhead', self.nav_invisible).length;
        },
        ...
        _collapseNavItem: function() {
            var $last_child = $('li.overhead:last-child', self.nav_visible);
        ...
        _expandNavItem: function() {
            var $first = $('li.overhead:first-child', self.nav_invisible);
        ...
        _expandAllItems: function() {
            $('li.overhead', self.nav_invisible).detach().appendTo(self.nav_visible);
            self.options.itemDisplayed.call();
        },

        _collapseAllItems: function() {
            $('li.overhead', self.nav_visible).detach().appendTo(self.nav_invisible);
            self.options.itemHidden.call();
        },

        destroy: function() {
            $('li.overhead', self.nav_invisible).appendTo(self.nav_visible);
